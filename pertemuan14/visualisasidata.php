...
<?php
  ...
  $result = pg_query($dbconn, "SELECT jenis_pemeriksaan, COUNT(*) AS jumlah from pemeriksaan group by jenis_pemeriksaan order by jenis_pemeriksaan; ") or exit("Error with quering database");
  ...
  // creating an associative array to store the chart attributes
	$arrData = array(
        "chart" => array(
            ...
            "caption"=> "Data jenis pemeriksaan",
          	"captionFontSize"=> "24",
            ...
            "toolTipColor"=> "#4D394B",
            "plotToolText"=> "<div style='text-align: center; line-height: 1.5;'>\$label<br>\$value Pemeriksaan<div>",
