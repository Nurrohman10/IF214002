...
$dbname = "mciis";
  ...
  function ambilSemuaPemeriksaan($host, $dbuser, $dbpass, $port, $dbname) {
    try {
      ...
      $objekPerintah = $link->prepare("SELECT * FROM pemeriksaan");
      ...
      ambilSemuaPemeriksaan($host, $dbuser, $dbpass, $port, $dbname);  
